...
% COMPUTETANGENTSTIFFNESSANDFORCE - Plastic Tangent Stiffness (Total Strain Version).
    ...
    h = obj.Thickness;
    [~, D_s] = obj.getConstitutiveMatrix();
    
    % Integration Scheme: 2x2 Gauss x 5 Simpson
    sqrt3_inv = 1/sqrt(3);
    ...
    for i = 1:2
        for j = 1:2
            ...
            for k = 1:5
                ...
                % Store Trial History
                NewHistory(pt_counter).sigma = sig_new; % For plotting only
